...
-- Usage: ./gen-docs.do
-- Import styles instead of inlining: ./gen-docs.do -import-style
...
<header>
    <h1 class="title">Doe Docs</h1>
    <div class="sub-title">%{version}</div>
    <ul>
        <li><a href="api.html">API Docs</a></li>
        <li><a href="https://github.com/azhai/doe/edit/master/docs/docs.md" target="_blank" rel="noopener">Edit Page</a></li>
    </ul>
...
fn gen_api_docs(version str) -> !void:
    core_mods := []ModulePair{
        {path='../src/builtins/core.do', section='core'},
        {path='../src/builtins/c.do', section='c'},
        {path='../src/builtins/cy.do', section='cy'},
        {path='../src/builtins/meta.do', section='meta'},
    }

    std_mods := []ModulePair{
        {path='../src/std/cli.do', section='cli'},
        {path='../src/std/libc.do', section='libc'},
        {path='../src/std/io.do', section='io'},
        {path='../src/std/math.do', section='math'},
        {path='../src/std/os.do', section='os'},
        {path='../src/std/test.do', section='test'},
    }
