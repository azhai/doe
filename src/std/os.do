...
use macos 'os.macos.do'

#[cond=meta.system() == .linux]
use linux 'os.linux.do'

#[cond=meta.system() != .windows]
use lc 'libc.do'

#[cond=meta.system() == .windows]
use windows 'os.windows.do'

#[cond=meta.system() == .windows]
use kernel32 'windows/kernel32.do'
...
--| - os.macos.do: macOS-specific implementations
--| - os.windows.do: Windows-specific implementations
--| - os.linux.do: Linux-specific implementations
--|
--| Sample usage:
--| ```cy
--| use os
