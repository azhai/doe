        ...
        while (true) {
            ...
            switch (task.kind) {
                .thread => {
                    ...
                    // Set up initial frame: fp points to call info slot, fp_end points to top of stack (safe default since we preallocated enough space).
                    thread.c.fp = thread.c.stack_ptr;
                    thread.c.fp_end = thread.c.stack_end;
