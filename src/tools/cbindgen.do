...
-- usage: ./cbindgen.do -o=llvm.do /path/to/LLVM.h -lib-path='libLLVM.dylib' -strip-prefix=LLVM
-- `-clang -I/opt/homebrew/Cellar/llvm/20.1.7/lib/clang/20/include` if missing libc headers.

use clang 'clang_bs.do'
...
out_path := args.get('o') ?else 'bindings.do'
...
out += '-- Code below is generated by cbindgen.do\n'
