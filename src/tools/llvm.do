-- ./src/tools/cbindgen.do -o=src/tools/llvm.do src/tools/llvm.h -clang -isysroot -clang /Library/Developer/CommandLineTools/SDKs/MacOSX26.sdk -clang -I/opt/homebrew/Cellar/llvm/20.1.7/include -lib-path=libLLVM.dylib -strip-prefix=LLVM

-- CBINDGEN MARKER
-- Code below is generated by cbindgen.do
use c
use meta
