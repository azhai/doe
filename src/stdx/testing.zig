...
pub fn eqUnionEnum(act: anytype, exp: @TypeOf(.enum_literal)) !void {
...
pub const Mock = struct {
    ...
    pub fn add(self: *Self, comptime E: @TypeOf(.enum_literal)) void {
    ...
    pub fn getNumCalls(self: Self, comptime E: @TypeOf(.enum_literal)) u32 {
